        ...
        <section id="informasi" class="my-10">
            ...
            <div class="grid gap-4 md:grid-cols-3 mt-6">
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h3 class="text-2xl font-semibold">Pengumuman 1</h3>
                    <p class="mt-2 text-gray-600">Detail pengumuman...</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h3 class="text-2xl font-semibold">Pengumuman 2</h3>
                    <p class="mt-2 text-gray-600">Detail pengumuman...</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-md">
                    <h3 class="text-2xl font-semibold">Pengumuman 3</h3>
                    <p class="mt-2 text-gray-600">Detail pengumuman...</p>
                </div>
            </div>
        </section>
